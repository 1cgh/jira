...
Функция Спринты(ИдентификаторДоски, НачинаяС = Неопределено, МаксКоличествоРезультатов = Неопределено,
	...
	ПараметрыЗапроса = Новый Структура;
	ВставитьЗначениеВСтруктуруЕслиОпределено(ПараметрыЗапроса, НачинаяС, "startAt");
	ВставитьЗначениеВСтруктуруЕслиОпределено(ПараметрыЗапроса, МаксКоличествоРезультатов, "maxResults");
	ВставитьЗначениеВСтруктуруЕслиОпределено(ПараметрыЗапроса, Состояние, "state");
